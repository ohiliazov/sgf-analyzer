...
defaults = {
    ...
    'analyze_threshold': 0.01,  # Display analysis on moves losing approx at least this much winrate
    'variations_threshold': 0.01,  # Explore variations on moves losing approx at least this much winrate
    ...
    'num_to_show': 3,  # Number of moves to show from the sequence of suggested moves
    ...
    'verbosity': 0,  # Set the verbosity level, 0: progress only, 1: progress+status, 2: progress+status+state

...
class Number(SuperType, AddMulMixin, ModMixin):
    ...
    def __coerce__(self, other):
        ...
        common_type = type(self.data + other)
        return common_type(self.data), common_type(other)
...
class String(Container, AddMulMixin, ModMixin):
...
class Tuple(Container, AddMulMixin):
...
class MutableSequence(Container, AddMulMixin, MutableMixin):
